...
app.UseAntiforgery();
app.MapRazorPages();
app.MapRazorComponents<ElliciumBlazorDemos.Host.App>()
    .AddInteractiveWebAssemblyRenderMode().AddAdditionalAssemblies(typeof(ElliciumBlazorDemos.App).Assembly);
app.MapControllers();
app.Run();