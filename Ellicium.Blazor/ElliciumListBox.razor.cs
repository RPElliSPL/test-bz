...
{
    /// <summary>
    /// ElliciumListBox component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumListBox @bind-Value=@customerID TValue="string" Data=@customers TextProperty="CompanyName" ValueProperty="CustomerID" Change=@(args => Console.WriteLine($"Selected CustomerID: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumListBox<TValue> : DropDownBase<TValue>
    {
        /// <summary>
        ...
        {
            builder.OpenComponent(0, typeof(ElliciumListBoxItem<TValue>));
        ...
        protected async System.Threading.Tasks.Task OnKeyDown(Microsoft.AspNetCore.Components.Web.KeyboardEventArgs args)
        {
            ...
            {
                await JSRuntime.InvokeAsync<string>("Ellicium.setInputValue", search, key);
                await JSRuntime.InvokeVoidAsync("Ellicium.focusElement", SearchID);
            }
