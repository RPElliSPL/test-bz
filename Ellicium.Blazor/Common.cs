...
namespace Ellicium
{
    ...
    {
        /// <summary>
        /// Add Ellicium Blazor components services
        /// </summary>
        /// <param name="services">Service collection</param>
        public static IServiceCollection AddElliciumComponents(this IServiceCollection services)
        {
...
#endif
    /// <summary>
    /// Represents the common <see cref="ElliciumSelectBar{TValue}" /> API used by
    /// its items. Injected as a cascading property in <see cref="ElliciumSelectBarItem" />.
    /// </summary>
    public interface IElliciumSelectBar
    {
        /// <summary>
        /// Adds the specified item to the select bar.
        /// </summary>
        /// <param name="item">The item to add.</param>
        void AddItem(ElliciumSelectBarItem item);

        /// <summary>
        /// Removes the specified item from the select bar.
        /// </summary>
        /// <param name="item">The item.</param>
        void RemoveItem(ElliciumSelectBarItem item);
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDatePicker{TValue}.DateRender" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// A class that represents a <see cref="ElliciumGoogleMap" /> position.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumGoogleMap.MapClick" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumMenu.Click" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumUpload.Error" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class RowRenderEventArgs<T>
    {
        /// <summary>
        /// Gets or sets the row HTML attributes. They will apply to the table row (tr) element which ElliciumDataGrid renders for every row.
        /// </summary>
        public IDictionary<string, object> Attributes { get; private set; } = new Dictionary<string, object>();
    ...
    {
        /// <summary>
        /// Gets or sets the group row HTML attributes. They will apply to the table row (tr) element which ElliciumDataGrid renders for every group row.
        /// </summary>
        public IDictionary<string, object> Attributes { get; private set; } = new Dictionary<string, object>();
        ...
        /// <summary>
        /// Gets a value indicating whether this is the first time the ElliciumGrid has rendered.
        /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumGrid{TItem}.Render" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class GridRenderEventArgs<T>
    {
        /// <summary>
        /// Gets the instance of the ElliciumGrid component which has rendered.
        /// </summary>
        public ElliciumGrid<T> Grid { get; internal set; }
        /// <summary>
        /// Gets a value indicating whether this is the first time the ElliciumGrid has rendered.
        /// </summary>
        /// <value><c>true</c> if this is the first time; otherwise, <c>false</c>.</value>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.Render" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridRenderEventArgs<T>
    {
        /// <summary>
        /// Gets the instance of the ElliciumDataGrid component which has rendered.
        /// </summary>
        public ElliciumDataGrid<T> Grid { get; internal set; }
        /// <summary>
        /// Gets a value indicating whether this is the first time the ElliciumDataGrid has rendered.
        /// </summary>
        /// <value><c>true</c> if this is the first time; otherwise, <c>false</c>.</value>
        public bool FirstRender { get; internal set; }
    }
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.LoadSettings" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumGrid{TItem}.CellRender" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class CellRenderEventArgs<T> : RowRenderEventArgs<T>
    {
        /// <summary>
        /// Gets the ElliciumGridColumn which this cells represents.
        /// </summary>
        public ElliciumGridColumn<T> Column { get; internal set; }
    }

    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.CellRender" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridCellRenderEventArgs<T> : RowRenderEventArgs<T>
    {
        /// <summary>
        /// Gets the ElliciumDataGridColumn which this cells represents.
        /// </summary>
        public ElliciumDataGridColumn<T> Column { get; internal set; }
    }

    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.CellContextMenu" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.RowClick" /> or <see cref="ElliciumDataGrid{TItem}.RowDoubleClick" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumUpload.Change" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumUpload.Progress" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumUpload.Complete" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Represents a file which the user selects for upload via <see cref="ElliciumUpload" />.
    /// </summary>
    ...
    /// <summary>
    /// Represents the preview which <see cref="ElliciumUpload" /> displays for selected files.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the ways a <see cref="ElliciumTabs" /> component renders its items.
    /// </summary>
    public enum TabRenderMode
    {
        /// <summary>
        /// The ElliciumTabs component switches its items server side. Only the selected item is rendered.
        /// </summary>
        Server,
        /// <summary>
        /// The ElliciumTabs components switches its items client-side. All items are rendered and the unselected ones are hidden with CSS.
        /// </summary>
        Client
    }

    /// <summary>
    /// Specifies the ways a <see cref="ElliciumTabs" /> component renders its titles.
    /// </summary>
    public enum TabPosition
    {
        /// <summary>
        /// The ElliciumTabs titles are displayed at the top of the component.
        /// </summary>
        Top,
        /// <summary>
        /// The ElliciumTabs titles are displayed at the top right side of the component.
        /// </summary>
        TopRight,
        /// <summary>
        /// The ElliciumTabs titles are displayed at the bottom of the component.
        /// </summary>
        Bottom,
        /// <summary>
        /// The ElliciumTabs titles are displayed at the bottom right side of the component.
        /// </summary>
        BottomRight,
        /// <summary>
        /// The ElliciumTabs titles are displayed at the left side of the component.
        /// </summary>
        Left,
        /// <summary>
        /// The ElliciumTabs titles are displayed at the right side of the component.
        /// </summary>
        Right
    }

    /// <summary>
    /// Specifies the ways a <see cref="ElliciumTimeline" /> component renders line and content items.
    /// </summary>
    public enum LinePosition
    {
        /// <summary>
        /// The ElliciumTimeline line is displayed at the center of the component.
        /// </summary>
        Center,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the center of the component with alternating content position.
        /// </summary>
        Alternate,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the start of the component.
        /// </summary>
        Start,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the end of the component.
        /// </summary>
        End,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the left side of the component.
        /// </summary>
        Left,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the right side of the component.
        /// </summary>
        Right,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the top of the component.
        /// </summary>
        Top,
        /// <summary>
        /// The ElliciumTimeline line is displayed at the bottom of the component.
        /// </summary>
        Bottom
    }

    /// <summary>
    /// Specifies the position at which a Ellicium Blazor component renders its built-in <see cref="ElliciumPager" />.
    /// </summary>
    [Flags]
    public enum PagerPosition
    {
        /// <summary>
        /// ElliciumPager is displayed at the top of the component.
        /// </summary>
        Top = 1,
        /// <summary>
        /// ElliciumPager is displayed at the bottom of the component.
        /// </summary>
        Bottom = 2,
        /// <summary>
        /// ElliciumPager is displayed at the top and at the bottom of the component.
        /// </summary>
        TopAndBottom = Top | Bottom
    }

    /// <summary>
    /// Specifies the expand behavior of <see cref="ElliciumDataGrid{TItem}" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the inline edit mode behavior of <see cref="ElliciumDataGrid{TItem}" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the selection mode behavior of <see cref="ElliciumDataGrid{TItem}" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the grid lines of <see cref="ElliciumDataGrid{TItem}" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the severity of a <see cref="ElliciumNotification" />. Severity changes the visual styling of the ElliciumNotification (icon and background color).
    /// </summary>
    ...
    /// <summary>
    /// Specifies the display style or severity of a <see cref="ElliciumAlert" />. Affects the visual styling of ElliciumAlert (background and text color).
    /// </summary>
    ...
    /// <summary>
    /// Specifies the size of a <see cref="ElliciumAlert" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the size of a point in <see cref="ElliciumTimelineItem" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the display style or severity of a <see cref="ElliciumTimelineItem" />
    /// </summary>
    ...
    /// <summary>
    /// Specifies the behavior of <see cref="ElliciumProgressBar" /> or <see cref="ElliciumProgressBarCircular" />.
    /// </summary>
    public enum ProgressBarMode
    {
        /// <summary>
        /// ElliciumProgressBar displays its value as a percentage range (0 to 100).
        /// </summary>
        Determinate,
        /// <summary>
        /// ElliciumProgressBar displays continuous animation.
        /// </summary>
        Indeterminate
    }

    /// <summary>
    /// Specifies the display style of a <see cref="ElliciumProgressBar" /> and <see cref="ElliciumProgressBarCircular" />. Affects the visual styling of ElliciumProgressBar (background and text color) and ElliciumProgressBarCircular (stroke and text color).
    /// </summary>
    ...
    /// <summary>
    /// Specifies the size of a <see cref="ElliciumProgressBarCircular" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the type of a <see cref="ElliciumButton" />. Renders as the <c>type</c> HTML attribute.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the size of a <see cref="ElliciumButton" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the display style of a <see cref="ElliciumButton" />. Affects the visual styling of ElliciumButton (background and text color).
    /// </summary>
    ...
    /// <summary>
    /// Specifies the design variant of <see cref="ElliciumButton" /> and <see cref="ElliciumBadge" />. Affects the visual styling of ElliciumButton and ElliciumBadge.
    /// </summary>
    public enum Variant
    {
        /// <summary>
    ...
    /// <summary>
    /// Specifies the color shade of a <see cref="ElliciumButton" />. Affects the visual styling of ElliciumButton.
    /// </summary>
    public enum Shade
    {
        /// <summary>
    ...
    /// <summary>
    /// Specifies the filtering mode of <see cref="ElliciumDataGrid{TItem}" />.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the display style of a <see cref="ElliciumBadge" />. Affects the visual styling of ElliciumBadge (background and text color).
    /// </summary>
    ...
    /// <summary>
    /// Specifies the display style of a <see cref="ElliciumIcon" />. Affects the visual styling of ElliciumIcon (Icon (text) color).
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.PickedColumnsChanged" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridPickedColumnsChangedEventArgs<T>
    {
        ...
        /// </summary>
        public IEnumerable<ElliciumDataGridColumn<T>> Columns { get; internal set; }
    }

    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.Sort" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridColumnSortEventArgs<T>
    {
        /// <summary>
        /// Gets the sorted ElliciumDataGridColumn.
        /// </summary>
        public ElliciumDataGridColumn<T> Column { get; internal set; }
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.Group" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.Filter" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridColumnFilterEventArgs<T>
    {
        /// <summary>
        /// Gets the filtered ElliciumDataGridColumn.
        /// </summary>
        public ElliciumDataGridColumn<T> Column { get; internal set; }
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.ColumnResized" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridColumnResizedEventArgs<T>
    {
        /// <summary>
        /// Gets the resized ElliciumDataGridColumn.
        /// </summary>
        public ElliciumDataGridColumn<T> Column { get; internal set; }
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.ColumnReordered" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class DataGridColumnReorderedEventArgs<T>
    {
        /// <summary>
        /// Gets the reordered ElliciumDataGridColumn.
        /// </summary>
        public ElliciumDataGridColumn<T> Column { get; internal set; }
        /// <summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumGrid{TItem}.ColumnResized" /> event that is being raised.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class ColumnResizedEventArgs<T>
    {
        /// <summary>
        /// Gets the resized ElliciumGridColumn.
        /// </summary>
        public ElliciumGridColumn<T> Column { get; internal set; }
        /// <summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumDataGrid{TItem}.LoadChildData" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumPager.PageChanged" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Contains the commands which <see cref="ElliciumHtmlEditor" /> supports.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumHtmlEditor.Paste" /> event that is being raised.
    /// </summary>
    public class HtmlEditorPasteEventArgs
    {
        /// <summary>
        /// Gets or sets the HTML content that is pasted in ElliciumHtmlEditor. Use the setter to filter unwanted markup from the pasted value.
        /// </summary>
    ...
    /// <summary>
    /// Represents a data item in a <see cref="ElliciumChart" />.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumChart.SeriesClick" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumChart.LegendClick" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumHtmlEditor.Execute" /> event that is being raised.
    /// </summary>
    public class HtmlEditorExecuteEventArgs
    {
        /// <summary>
        /// Gets the ElliciumHtmlEditor instance which raised the event.
        /// </summary>
        public ElliciumHtmlEditor Editor { get; set; }

        internal HtmlEditorExecuteEventArgs(ElliciumHtmlEditor editor)
        {
            Editor = editor;
        }

        /// <summary>
        /// Gets the name of the command which ElliciumHtmlEditor is executing.
        /// </summary>
        public string CommandName { get; set; }
    }

    /// <summary>
    /// Supplies information about a <see cref="ElliciumTree.Change" /> event that is being raised.
    /// </summary>
    public class TreeEventArgs
    {
        /// <summary>
        /// Gets the <see cref="ElliciumTreeItem.Text" /> the selected ElliciumTreeItem.
        /// </summary>
        public string Text { get; set; }
        /// <summary>
        /// Gets the <see cref="ElliciumTreeItem.Value" /> the selected ElliciumTreeItem.
        /// </summary>
        public object Value { get; set; }
    }

    /// <summary>
    /// Supplies information about a <see cref="ElliciumTree.Expand" /> event that is being raised.
    /// </summary>
    public class TreeExpandEventArgs
    {
        /// <summary>
        /// Gets the <see cref="ElliciumTreeItem.Text" /> the expanded ElliciumTreeItem.
        /// </summary>
        public object Value { get; set; }
        /// <summary>
        /// Gets the <see cref="ElliciumTreeItem.Value" /> the expanded ElliciumTreeItem.
        /// </summary>
        public string Text { get; set; }
        /// <summary>
        /// Gets or sets the children of the expanded ElliciumTreeItem.
        /// </summary>
    ...
    /// <summary>
    /// The configuration used by a <see cref="ElliciumTreeItem" /> to create child items.
    /// </summary>
    public class TreeItemSettings
    {
        /// <summary>
        /// Gets or sets the data from which child items will be created. The parent node enumerates the data and creates a new ElliciumTreeItem for every item.
        /// </summary>
        public IEnumerable Data { get; set; }
        /// <summary>
        /// Gets or sets the function which returns a value for the <see cref="ElliciumTreeItem.Text" /> of a child item.
        /// </summary>
        public Func<object, string> Text { get; set; }
        /// <summary>
        /// Gets or sets the name of the property which provides the value for the <see cref="ElliciumTreeItem.Text" /> of a child item.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="ElliciumTreeItem.Template" /> of a child item.
        /// </summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumLogin.Login" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// Represents the common <see cref="ElliciumTemplateForm{TItem}" /> API used by
    /// its items. Injected as a cascading property in <see cref="IElliciumFormComponent" />.
    /// </summary>
    public interface IElliciumForm
    {
        /// <summary>
        /// Adds the specified component to the form.
        /// </summary>
        /// <param name="component">The component to add to the form.</param>
        void AddComponent(IElliciumFormComponent component);
        /// <summary>
        /// Removes the component from the form.
        /// </summary>
        /// <param name="component">The component to remove from the form.</param>
        void RemoveComponent(IElliciumFormComponent component);
        /// <summary>
        /// Finds a form component by its name.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <returns>The component whose <see cref="IElliciumFormComponent.Name" /> equals to <paramref name="name" />; <c>null</c> if such a component is not found.</returns>
        IElliciumFormComponent FindComponent(string name);
    }

    /// <summary>
    /// Specifies the interface that form components must implement in order to be supported by <see cref="ElliciumTemplateForm{TItem}" />.
    /// </summary>
    public interface IElliciumFormComponent
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns>the value of the component - for example the text of ElliciumTextBox.</returns>
        object GetValue();
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumTemplateForm{TItem}.InvalidSubmit" /> event that is being raised.
    /// </summary>
    ...
    /// <summary>
    /// The interface that a validator component must implement in order to be supported by <see cref="ElliciumTemplateForm{TItem}" />.
    /// </summary>
    public interface IElliciumFormValidator
    {
        /// <summary>
    ...
    /// </summary>
    public class ElliciumComponentWithChildren : ElliciumComponent
    {
        /// <summary>
    ...
    /// </summary>
    public class ElliciumFlexComponent : ElliciumComponentWithChildren
    {
        /// <summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumSplitter.Expand" /> or <see cref="ElliciumSplitter.Collapse" /> event that is being raised.
    /// </summary>
    public class ElliciumSplitterEventArgs
    {
        /// <summary>
        ...
        public ElliciumSplitterPane Pane { get; set; }
        /// <summary>
    ...
    /// <summary>
    /// Supplies information about a <see cref="ElliciumSplitter.Resize" /> event that is being raised.
    /// </summary>
    public class ElliciumSplitterResizeEventArgs : ElliciumSplitterEventArgs
    {
        /// <summary>
