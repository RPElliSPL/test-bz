...
{
    /// <summary>
    /// ElliciumPanelMenuItem component.
    /// </summary>
    public partial class ElliciumPanelMenuItem : ElliciumComponent
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumPanelMenuItem"/> is expanded.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumPanelMenuItem"/> is selected.
        /// </summary>
        ...
        internal async System.Threading.Tasks.Task Toggle()
        {
            ...
            {
                var itemsToSkip = new List<ElliciumPanelMenuItem>();
                var p = ParentItem;
                while (p != null)
                {
                    itemsToSkip.Add(p);
        ...
        ElliciumPanelMenuItem _parentItem;
        ...
        [CascadingParameter]
        public ElliciumPanelMenuItem ParentItem
        {
            get
            {
                return _parentItem;
        ...
        [CascadingParameter]
        public ElliciumPanelMenu Parent
        {
            get
            {
                return _parent;
