...
{
    /// <summary>
    /// ElliciumAutoComplete component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumAutoComplete Data=@customers TextProperty="CompanyName" Change=@(args => Console.WriteLine($"Selected text: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumAutoComplete : DataBoundFormComponent<string>
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumAutoComplete"/> is multiline.
        /// </summary>
        ...
        protected async Task OnFilterKeyPress(KeyboardEventArgs args)
        {
            ...
            if (key == "ArrowDown" || key == "ArrowUp")
            {
                try
                {
                    selectedIndex = await JSRuntime.InvokeAsync<int>("Ellicium.focusListItem", search, list, key == "ArrowDown", selectedIndex);
                }
                catch (Exception)
                {
                    //
        ...
        {
            var value = await JSRuntime.InvokeAsync<string>("Ellicium.getInputValue", search);
            ...
            else
            {
                ...
                await InvokeAsync(() => { LoadData.InvokeAsync(new Ellicium.LoadDataArgs() { Filter = customSearchText }); });
            }
        }
        ...
        private string OpenScript()
        {
            ...
            return $"Ellicium.openPopup(this.parentNode, '{PopupID}', true)";
        }
