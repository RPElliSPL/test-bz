...
{
    /// <summary>
    /// ElliciumNumeric component.
    /// </summary>
    /// <typeparam name="TValue">The type of the t value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumNumeric TValue="int" Min="1" Max="10" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumNumeric<TValue> : FormComponentWithAutoComplete<TValue>
    {
        /// <summary>
        ...
        private string getOnInput()
        {
            ...
            return (Min != null || Max != null) ? $@"Ellicium.numericOnInput(event, {minArg ?? "null"}, {maxArg ?? "null"}, {isNull})" : "";
        }
        ...
        private string getOnPaste()
        {
            ...
            return Min != null || Max != null ? $@"Ellicium.numericOnPaste(event, {minArg ?? "null"}, {maxArg ?? "null"})" : "";
        }
