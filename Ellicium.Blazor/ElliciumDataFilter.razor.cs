...
{
    /// <summary>
    /// ElliciumDataFilter component.
    /// </summary>
    /// <typeparam name="TItem">The type of the item.</typeparam>
    public partial class ElliciumDataFilter<TItem> : ElliciumComponent
    {
        /// <inheritdoc />
        ...
        public IList<ElliciumDataFilterProperty<TItem>> PropertiesCollection
        {
            get
            {
                return properties;
        ...
        internal List<ElliciumDataFilterProperty<TItem>> properties = new List<ElliciumDataFilterProperty<TItem>>();
        internal void AddProperty(ElliciumDataFilterProperty<TItem> property)
        {
        ...
        internal void RemoveProperty(ElliciumDataFilterProperty<TItem> property)
        {
            if (properties.Contains(property))
            {
