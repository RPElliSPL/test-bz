...
{
    /// <summary>
    /// ElliciumFileInput component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumFileInput @bind-Value=@employee.Photo TValue="string" Change=@(args => Console.WriteLine($"File content as base64 string: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumFileInput<TValue> : FormComponent<TValue>
    {
        /// <summary>
        ...
        async Task OnChange()
        {
            ...
            try
            {
                uploadValue = await JSRuntime.InvokeAsync<string>("Ellicium.readFileAsBase64", fileUpload, MaxFileSize, MaxWidth, MaxHeight);
        ...
        async System.Threading.Tasks.Task Remove(EventArgs args)
        {
            ...
            await JSRuntime.InvokeVoidAsync("Ellicium.removeFileFromFileInput", fileUpload);
