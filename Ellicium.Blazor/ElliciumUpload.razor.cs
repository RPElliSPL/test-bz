...
{
    /// <summary>
    /// ElliciumUpload component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumUpload Url="upload/single" Progress=@(args => OnProgress(args, "Single file upload"))/&gt;
    /// @code {
    ...
    public partial class ElliciumUpload : ElliciumComponent
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumUpload"/> upload is automatic.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumUpload"/> is multiple.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumUpload"/> is disabled.
        /// </summary>
        ...
        {
            await JSRuntime.InvokeAsync<string>("Ellicium.upload", fileUpload, Url, Multiple, false, ParameterName);
        }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.uploads", Reference, Name ?? GetId());
                }
            }
        }
        ...
        {
            files.Remove(file);
            await JSRuntime.InvokeVoidAsync("Ellicium.removeFileFromUpload", fileUpload, file.Name);
            await Change.InvokeAsync(new UploadChangeEventArgs() { Files = files.Select(f => new FileInfo() { Name = f.Name, Size = f.Size }).ToList() });
        }
        ...
        [JSInvokable("ElliciumUpload.OnChange")]
        ...
        [JSInvokable("ElliciumUpload.OnProgress")]
        ...
        [JSInvokable("ElliciumUpload.OnComplete")]
        ...
        [JSInvokable("ElliciumUpload.OnError")]
