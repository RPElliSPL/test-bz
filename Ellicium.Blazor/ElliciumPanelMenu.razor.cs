...
{
    /// <summary>
    /// ElliciumPanelMenu component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumPanelMenu&gt;
    ///     &lt;ElliciumPanelMenuItem Text="Data"&gt;
    ///         &lt;ElliciumPanelMenuItem Text="Orders" Path="orders" /&gt;
    ///         &lt;ElliciumPanelMenuItem Text="Employees" Path="employees" /&gt;
    ///     &lt;/ElliciumPanelMenuItemItem&gt;
    /// &lt;/ElliciumPanelMenu&gt;
    /// </code>
    /// </example>
    public partial class ElliciumPanelMenu : ElliciumComponentWithChildren
    {
        ...
        internal List<ElliciumPanelMenuItem> items = new List<ElliciumPanelMenuItem>();

        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(ElliciumPanelMenuItem item)
        {
        ...
        {
            var allExpandedItems = items.Concat(items.SelectManyRecursive(i => i.ExpandedInternal ? i.items : Enumerable.Empty<ElliciumPanelMenuItem>()));
        ...
        internal void CollapseAll(IEnumerable<ElliciumPanelMenuItem> itemsToSkip)
        {
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            {
                CollapseAll(Enumerable.Empty<ElliciumPanelMenuItem>());
            }
        ...
        internal void SelectItem(ElliciumPanelMenuItem item)
        {
        ...
        List<ElliciumPanelMenuItem> currentItems;
        ...
        async Task OnKeyPress(KeyboardEventArgs args)
        {
            ...
            if (key == "ArrowUp" || key == "ArrowDown")
            {
                ...
                try
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.scrollIntoViewIfNeeded", currentItems[focusedIndex].Element);
                }
                catch
                { }
            }
        ...
        internal bool IsFocused(ElliciumPanelMenuItem item)
        {
            return currentItems?.IndexOf(item) == focusedIndex && focusedIndex != -1;
        }

        internal void RemoveItem(ElliciumPanelMenuItem item)
        {
            items.Remove(item);
