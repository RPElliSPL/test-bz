...
namespace Ellicium.Blazor
{
    ...
    public abstract class GaugeBase : ElliciumComponent
    {
        /// <summary>
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    var rect = await JSRuntime.InvokeAsync<Rect>("Ellicium.createGauge", Element, Reference);
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            if (visibleChanged && !firstRender)
            {
                if (Visible == false)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.destroyGauge", Element);
                }
            }
        ...
        public override void Dispose()
        {
            ...
            if (Visible)
            {
                JSRuntime.InvokeVoidAsync("Ellicium.destroyGauge", Element);
            }
        }
