...
namespace Ellicium
{
    ...
    /// var activator = new ElliciumComponentActivator();
    /// // Replace ElliciumButton with MyButton
    /// activator.Override&lt;ElliciumButton, MyButton&gt;();
    /// // Replace ElliciumDataGrid with MyDataGrid
    /// activator.Override(typeof(ElliciumDataGrid&lt;&gt;), typeof(MyDataGrid&lt;&gt;));
    /// // Register the activator
    /// builder.Services.AddSingleton&lt;IComponentActivator&gt;(activator);
    /// </code>
    /// </example>
    public class ElliciumComponentActivator : IComponentActivator
    {
