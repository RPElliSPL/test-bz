...
{
    /// <summary>
    /// ElliciumContextMenu component.
    /// </summary>
    /// <example>
    /// <code>
    /// @inject ContextMenuService ContextMenuService
    /// 
    /// &lt;ElliciumButton Text="Show context menu" ContextMenu=@(args => ShowContextMenuWithItems(args)) /&gt;
    /// 
    /// @code {
    ...
    /// </code>
    /// </example>
    public partial class ElliciumContextMenu : IAsyncDisposable
    {
        /// <summary>
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (menu != null)
            {
                await JSRuntime.InvokeVoidAsync("Ellicium.openContextMenu",
                    menu.MouseEventArgs.ClientX,
                    menu.MouseEventArgs.ClientY,
                    UniqueID,
                    Reference,
                    "ElliciumContextMenu.CloseMenu");
            }
        }

        private DotNetObjectReference<ElliciumContextMenu> reference;

        /// <summary>
        /// Gets the reference for the current component.
        /// </summary>
        /// <value>The reference.</value>
        protected DotNetObjectReference<ElliciumContextMenu> Reference
        {
            get
            {
                if (reference == null)
        ...
        public async Task Close()
        {
            ...
            if (lastTooltip != null)
            {
                ...
                await JSRuntime.InvokeVoidAsync("Ellicium.closePopup", UniqueID);
            }
        ...
        /// Closes this instance.
        /// </summary>
        [JSInvokable("ElliciumContextMenu.CloseMenu")]
