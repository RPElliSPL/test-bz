...
namespace Ellicium
{
    ...
    public static class QueryableExtension
    {
        ...
        public static string ToFilterString<T>(this IEnumerable<ElliciumGridColumn<T>> columns)
        {
            Func<ElliciumGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToFilterString<T>(this IEnumerable<ElliciumDataGridColumn<T>> columns)
        {
        ...
        /// <returns>System.String.</returns>
        private static string GetColumnFilter<T>(ElliciumGridColumn<T> column, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        /// <param name="second">if set to <c>true</c> [second].</param>
        /// <returns>System.String.</returns>
        private static string GetColumnFilter<T>(ElliciumDataGridColumn<T> column, string value, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        /// <param name="second">if set to <c>true</c> [second].</param>
        /// <returns>System.String.</returns>
        private static string GetColumnODataFilter<T>(ElliciumGridColumn<T> column, bool second = false)
        {
            var columnType = column.Type;
            var columnFormat = column.Format;
        ...
        /// <returns>System.String.</returns>
        internal static string GetColumnODataFilter<T>(ElliciumDataGridColumn<T> column, object filterValue, FilterOperator columnFilterOperator)
        {
            var property = column.GetFilterProperty().Replace('.', '/');
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToODataFilterString<T>(this IEnumerable<ElliciumGridColumn<T>> columns)
        {
            Func<ElliciumGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToODataFilterString<T>(this IEnumerable<ElliciumDataGridColumn<T>> columns)
        {
            var columnsWithFilter = GetFilterableColumns(columns);
        ...
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<ElliciumGridColumn<T>> columns)
        {
            Func<ElliciumGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>IQueryable&lt;T&gt;.</returns>
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<ElliciumDataGridColumn<T>> columns)
        {
            Func<ElliciumDataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
        ...
        /// <returns>IQueryable&lt;T&gt;.</returns>
        public static IQueryable<T> Where<T>(this IQueryable<T> source, ElliciumDataFilter<T> dataFilter)
        {
        ...
        private static void AddWhereExpression<T>(Func<CompositeFilterDescriptor, bool> canFilter, CompositeFilterDescriptor filter, ref List<string> filterExpressions, ref List<object[]> filterValues, ref int index, ElliciumDataFilter<T> dataFilter)
        {
        ...
        /// <param name="dataFilter">The DataFilter.</param>
        /// <returns>System.String.</returns>
        public static string ToODataFilterString<T>(this ElliciumDataFilter<T> dataFilter)
        {
            Func<CompositeFilterDescriptor, bool> canFilter = (c) => dataFilter.properties.Where(col => col.Property == c.Property).FirstOrDefault()?.FilterPropertyType != null &&
               (!(c.FilterValue == null || c.FilterValue as string == string.Empty)
                || c.FilterOperator == FilterOperator.IsNotNull || c.FilterOperator == FilterOperator.IsNull
        ...
        private static void AddODataExpression<T>(Func<CompositeFilterDescriptor, bool> canFilter, CompositeFilterDescriptor filter, ref List<string> filterExpressions, ElliciumDataFilter<T> dataFilter)
        {
            if (filter.Filters != null)
            {
                var innerFilterExpressions = new List<string>();
        ...
        private static List<ElliciumDataGridColumn<T>> GetFilterableColumns<T>(IEnumerable<ElliciumDataGridColumn<T>> columns)
        {
            return columns
