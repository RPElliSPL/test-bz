...
namespace Ellicium.Blazor
{
    ...
    /// <code>
    ///   &lt;ElliciumChart&gt;
    ///       &lt;ElliciumColumnSeries Data=@revenue CategoryProperty="Quarter" ValueProperty="Revenue" /&gt;
    ///   &lt;/ElliciumChart&gt;
    ///   @code {
    ///       class DataItem
    ///       {
    ...
    public partial class ElliciumChart : ElliciumComponent
    {
        ...
        internal ElliciumColumnOptions ColumnOptions { get; set; } = new ElliciumColumnOptions();
        internal ElliciumBarOptions BarOptions { get; set; } = new ElliciumBarOptions();
        internal ElliciumLegend Legend { get; set; } = new ElliciumLegend();
        internal ElliciumCategoryAxis CategoryAxis { get; set; } = new ElliciumCategoryAxis();
        internal ElliciumValueAxis ValueAxis { get; set; } = new ElliciumValueAxis();
        internal ElliciumChartTooltipOptions Tooltip { get; set; } = new ElliciumChartTooltipOptions();
        ...
        {
            var pieType = typeof(ElliciumPieSeries<>);
            var donutType = typeof(ElliciumDonutSeries<>);
        ...
        /// <summary>
        /// Invoked via interop when the ElliciumChart resizes. Display the series with the new dimensions.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user moves the mouse over the ElliciumChart. Displays the tooltip.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user clicks the ElliciumChart. Raises the <see cref="SeriesClick" /> handler.
        /// </summary>
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        [JSInvokable]
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                ...
                if (Visible)
                {
                    var rect = await JSRuntime.InvokeAsync<Rect>("Ellicium.createChart", Element, Reference);
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            if (visibleChanged && !firstRender)
            {
                if (Visible == false)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.destroyChart", Element);
                }
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Ellicium.destroyChart", Element);
            }
        }
