...
{
    /// <summary>
    /// ElliciumSlider component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumSlider @bind-Value=@value TValue="int" Min="0" Max="100" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumSlider<TValue> : FormComponent<TValue>
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged || disabledChanged || maxChanged || minChanged || rangeChanged || stepChanged)
            {
                ...
                if (Visible && !Disabled)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.createSlider", UniqueID, Reference, Element, Range, Range ? minHandle : handle, maxHandle, Min, Max, Value, Step);
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Ellicium.destroySlider", UniqueID, Element);
            }
        }
        ...
        [JSInvokable("ElliciumSlider.OnValueChange")]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumSlider{TValue}"/> is range.
        /// </summary>
