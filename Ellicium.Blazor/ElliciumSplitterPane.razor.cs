...
namespace Ellicium.Blazor
{
    ...
    public partial class ElliciumSplitterPane : ElliciumComponent
    {
        ...
        internal ElliciumSplitterPane Next()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumSplitterPane"/> is collapsible.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumSplitterPane"/> is collapsed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumSplitterPane"/> is resizable.
        /// </summary>
        ...
        [CascadingParameter]
        public ElliciumSplitter Splitter
        {
            get => _splitter;
            set
            {
        ...
        async Task OnKeyPress(KeyboardEventArgs args, bool? expand = null)
        {
            ...
            else if (key == "ArrowLeft" || key == "ArrowRight" || key == "ArrowUp" || key == "ArrowDown")
            {
                ...
                var rect = await JSRuntime.InvokeAsync<Rect>("Ellicium.clientRect", GetId() + "-resize");
                ...
                await JSRuntime.InvokeVoidAsync("Ellicium.resizeSplitter", UniqueID, new MouseEventArgs()
                {
