...
{
    /// <summary>
    /// ElliciumDatePicker component.
    /// </summary>
    /// <typeparam name="TValue">The type of the t value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumDatePicker @bind-Value=@someValue TValue="DateTime" Change=@(args => Console.WriteLine($"Selected date: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumDatePicker<TValue> : ElliciumComponent, IElliciumFormComponent
    {
        /// <summary>
        ...
        ElliciumDropDown<int> monthDropDown;
        ElliciumDropDown<int> yearDropDown;
        ...
        {
            DateTime? newValue;
            var inputValue = await JSRuntime.InvokeAsync<string>("Ellicium.getInputValue", input);
            ...
            else
            {
                ...
                if (nullable)
                {
                    await JSRuntime.InvokeAsync<string>("Ellicium.setInputValue", input, "");
                }
                else
                {
                    await JSRuntime.InvokeAsync<string>("Ellicium.setInputValue", input, FormattedValue);
                }
        ...
        /// <summary>
        /// Parse the input using an function outside the Ellicium-library
        /// </summary>
        [Parameter]
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDatePicker{TValue}"/> is inline - only Calender.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDatePicker{TValue}"/> is disabled.
        /// </summary>
        ...
        public void Close()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Ellicium.closePopup", PopupID);
            }
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            {
                await JSRuntime.InvokeVoidAsync("Ellicium.destroyPopup", PopupID);
            }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged || disabledChanged || readOnlyChanged || inlineChanged || popupRenderModeChanged)
            {
                ...
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.createDatePicker", Element, PopupID);
        ...
        public override void Dispose()
        {
            ...
            if (IsJSRuntimeAvailable)
            {
                ...
                JSRuntime.InvokeVoidAsync("Ellicium.destroyDatePicker", UniqueID, Element);
            }
        }
        ...
        async Task OnKeyPress(KeyboardEventArgs args)
        {
            ...
            if (args.AltKey && key == "ArrowDown")
            {
                ...
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.openPopup", Element, PopupID, false, null, null, null, null, null, true, true);
                }
                else
                {
        ...
        internal async Task TogglePopup()
        {
            if (PopupRenderMode == PopupRenderMode.Initial)
            {
                await JSRuntime.InvokeVoidAsync("Ellicium.togglePopup", Element, PopupID, false, null, null, true, true);
            }
            else
            {
                await popup.ToggleAsync(Element);
