...
{
    /// <summary>
    /// ElliciumTabs component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumTabs RenderMode="TabRenderMode.Client" Change=@(args => Console.WriteLine($"Selected index is: {args}"))&gt;
    ///     &lt;Tabs&gt;
    ///         &lt;ElliciumTabsItem Text="Orders"&gt;
    ///             Details for Orders
    ///         &lt;/ElliciumTabsItem&gt;
    ///         &lt;ElliciumTabsItem Text="Employees"&gt;
    ...
    public partial class ElliciumTabs : ElliciumComponent
    {
        ...
        List<ElliciumTabsItem> tabs = new List<ElliciumTabsItem>();

        /// <summary>
        /// Adds the tab.
        /// </summary>
        /// <param name="tab">The tab.</param>
        public async Task AddTab(ElliciumTabsItem tab)
        {
        ...
        /// <summary>
        /// Gets the currently selected ElliciumTabsItem based on the selectedIndex.
        /// </summary>

        public ElliciumTabsItem SelectedTab
        {
            get
            {
        ...
        public void RemoveItem(ElliciumTabsItem item)
        {
        ...
        internal bool IsSelected(ElliciumTabsItem tab)
        {
            return IndexOf(tab) == selectedIndex;
        }

        internal int IndexOf(ElliciumTabsItem tab)
        {
            return tabs.IndexOf(tab);
        }

        internal async Task SelectTab(ElliciumTabsItem tab, bool raiseChange = false)
        {
            selectedIndex = IndexOf(tab);
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (RenderMode == TabRenderMode.Client && previousSelectedIndex != selectedIndex)
            {
                ...
                await JSRuntime.InvokeVoidAsync("Ellicium.selectTab", $"{GetId()}-tabpanel-{selectedIndex}", selectedIndex);
            }
        ...
        internal async System.Threading.Tasks.Task SelectTabOnClient(ElliciumTabsItem tab)
        {
        ...
        internal ElliciumTabsItem FirstVisibleTab()
        {
        ...
        internal bool IsFocused(ElliciumTabsItem item)
        {
