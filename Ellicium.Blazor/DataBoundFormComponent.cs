...
namespace Ellicium
{
    ...
    /// Implements the <see cref="Ellicium.ElliciumComponent" />
    /// Implements the <see cref="Ellicium.IElliciumFormComponent" />
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <seealso cref="Ellicium.ElliciumComponent" />
    /// <seealso cref="Ellicium.IElliciumFormComponent" />
    public class DataBoundFormComponent<T> : ElliciumComponent, IElliciumFormComponent
    {
        /// <summary>
        ...
        [Parameter]
        public EventCallback<Ellicium.LoadDataArgs> LoadData { get; set; }
        ...
        /// <summary> Provides support for ElliciumFormField integration. </summary>
        [CascadingParameter]
        public IFormFieldContext FormFieldContext { get; set; }

        /// <summary> Gets the current placeholder. Returns empty string if this component is inside a ElliciumFormField.</summary>
