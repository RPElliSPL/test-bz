...
{
    /// <summary>
    /// Base class of Ellicium validator components.
    /// </summary>
    public abstract class ValidatorBase : ElliciumComponent, IElliciumFormValidator
    {
        /// <summary>
        /// Gets or sets the form which contains this validator.
        /// </summary>
        [CascadingParameter]
        public IElliciumForm Form { get; set; }

        /// <summary>
        /// Specifies the component which this validator should validate. Must be set to the <see cref="IElliciumFormComponent.Name" /> of an existing component.
        /// </summary>
        [Parameter]
        ...
        /// <summary>
        /// Provided by the <see cref="ElliciumTemplateForm{TItem}" /> which contains this validator. Used internally.
        /// </summary>
        ...
        protected abstract bool Validate(IElliciumFormComponent component);
