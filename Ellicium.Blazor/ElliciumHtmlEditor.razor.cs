...
namespace Ellicium.Blazor
{
    ...
    public partial class ElliciumHtmlEditor : FormComponent<string>
    {
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumHtmlEditor @bind-Value=@html Paste=@OnPaste /&gt;
        /// @code {
        ///   string html = "@lt;strong&gt;Hello&lt;/strong&gt; world!";
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumHtmlEditor Execute=@OnExecute&gt;
        ///   &lt;ElliciumHtmlEditorCustomTool CommandName="InsertToday" Icon="today" Title="Insert today" /&gt;
        /// &lt;/ElliciumHtmlEditor&gt;
        /// @code {
        ///   string html = "@lt;strong&gt;Hello&lt;/strong&gt; world!";
        ...
        /// <summary>
        /// Specifies the URL to which ElliciumHtmlEditor will submit files.
        /// </summary>
        [Parameter]
        public string UploadUrl { get; set; }

        ElementReference ContentEditable { get; set; }
        ElliciumTextArea TextArea { get; set; }
        ...
        internal ElliciumHtmlEditorCommandState State { get; set; } = new ElliciumHtmlEditorCommandState();
        ...
        /// <summary>
        /// Invoked by interop when the ElliciumHtmlEditor selection changes.
        /// </summary>
        [JSInvokable]
        ...
        {
            State = await JSRuntime.InvokeAsync<ElliciumHtmlEditorCommandState>("Ellicium.execCommand", ContentEditable, name, value);
        ...
        /// <summary>
        /// Executes the action associated with the specified shortcut. Used internally by ElliciumHtmlEditor.
        /// </summary>
        ...
        {
            Html = html;
            await JSRuntime.InvokeVoidAsync("Ellicium.innerHTML", ContentEditable, Html);
            await OnChange();
            StateHasChanged();
        }
        ...
        /// <summary>
        /// Saves the current selection. ElliciumHtmlEditor will lose its selection when it loses focus. Use this method to persist the current selection.
        /// </summary>
        public async Task SaveSelectionAsync()
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.saveSelection", ContentEditable);
        }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.restoreSelection", ContentEditable);
        }

        async Task UpdateCommandState()
        {
            State = await JSRuntime.InvokeAsync<ElliciumHtmlEditorCommandState>("Ellicium.queryCommands", ContentEditable);
        ...
        {
            return JSRuntime.InvokeAsync<T>("Ellicium.selectionAttributes", selector, attributes, ContentEditable);
        }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged)
            {
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.createEditor", ContentEditable, UploadUrl, Paste.HasDelegate, Reference, shortcuts.Keys);
                }
            }
            ...
            if (valueChanged || visibleChanged)
            {
                ...
                if (Visible)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.innerHTML", ContentEditable, Value);
                }
            }
        }
        ...
        /// <summary>
        /// Invoked via interop when the value of ElliciumHtmlEditor changes.
        /// </summary>
        ...
        /// <summary>
        /// Invoked via interop when the user pastes content in ElliciumHtmlEditor. Invokes <see cref="Paste" />.
        /// </summary>
        /// <param name="html">The HTML.</param>
        [JSInvokable]
        ...
        public override async Task SetParametersAsync(ParameterView parameters)
        {
            ...
            {
                await JSRuntime.InvokeVoidAsync("Ellicium.destroyEditor", ContentEditable);
            }
        }
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Ellicium.destroyEditor", ContentEditable);
            }
        }
    }
}
