...
namespace Ellicium.Blazor
{
    ...
    public partial class ElliciumMenuItem : ElliciumComponent
    {
        ...
        [CascadingParameter]
        public ElliciumMenuItem ParentItem
        {
            get
            {
                return _parentItem;
        ...
        ElliciumMenu _parent;
        /// <summary>
        /// Gets or sets the parent.
        /// </summary>
        /// <value>The parent.</value>
        [CascadingParameter]
        public ElliciumMenu Parent
        {
            get
            {
                return _parent;
        ...
        Dictionary<string, object> getOpenEvents()
        {
            ...
            if (!Disabled)
            {
                ...
                {
                    events.Add("onclick", "Ellicium.toggleMenuItem(this)");
                }
                else
                {
                    events.Add("onclick", "Ellicium.toggleMenuItem(this, event, false)");
                }
            }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.toggleMenuItem", Element);
        }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.toggleMenuItem", Element, "event", false);
        }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.toggleMenuItem", Element, "event", true);
        }
    }
}
