...
{
    /// <summary>
    /// ElliciumMask component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumMask Mask="(***) ***-****" Pattern="[^0-9]" Placeholder="(000) 000-0000" @bind-Value=@phone Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumMask : FormComponentWithAutoComplete<string>
    {
        ...
        protected override void OnAfterRender(bool firstRender)
        {
            ...
            if (firstRender)
            {
                JSRuntime.InvokeVoidAsync("eval", $"Ellicium.mask('{GetId()}', '{Mask}', '{Pattern}', '{CharacterPattern}')");
            }
        }
    }
}
