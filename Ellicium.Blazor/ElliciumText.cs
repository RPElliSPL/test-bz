...
namespace Ellicium.Blazor
{
    ...
    /// <example>
    ///   <code>
    /// &lt;ElliciumText TextStyle="TextStyle.H1"&gt;
    ///  Hello World
    /// &lt;/ElliciumText&gt;
    ///   </code>
    /// </example>
    public class ElliciumText : ElliciumComponent
    {
        class ElliciumTextAnchor : ComponentBase, IDisposable
        {
            [Inject]
            ...
            protected override void BuildRenderTree(RenderTreeBuilder builder)
            {
                ...
                builder.OpenComponent<ElliciumIcon>(7);
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            if (Visible)
            {
                ...
                {
                    builder.OpenComponent<ElliciumTextAnchor>(6);
                    builder.AddAttribute(7, nameof(ElliciumTextAnchor.Path), Anchor);
                    builder.CloseComponent();
                }
