...
namespace Ellicium.Blazor
{
    ...
    /// </code>
    /// </example>
    public class ElliciumTemplateForm<TItem> : ElliciumComponent, IElliciumForm
    {
        /// <summary>
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumTemplateForm TItem="Model" Submit=@OnSubmit Data=@model&gt;
        ///   &lt;ElliciumTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;ElliciumRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/ElliciumTemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumTemplateForm TItem="Model" InvalidSubmit=@OnInvalidSubmit Data=@model&gt;
        ///   &lt;ElliciumTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;ElliciumRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/ElliciumTemplateForm&gt;
        /// @code {
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumTemplateForm TItem="Model" Method="post" Action="/register" Data=@model&gt;
        ///   &lt;ElliciumTextBox style="display: block" Name="Email" @bind-Value=@model.Email /&gt;
        ///   &lt;ElliciumRequiredValidator Component="Email" Text="Email is required" Style="position: absolute" /&gt;
        /// &lt;/ElliciumTemplateForm&gt;
        /// </code>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ElliciumTemplateForm{TItem}"/> class.
        /// </summary>
        public ElliciumTemplateForm()
        {
        ...
        protected async Task OnSubmit()
        {
            if (EditContext != null)
            {
                ...
                if (valid)
                {
                    ...
                    if (Action != null)
                    {
                        await JSRuntime.InvokeVoidAsync($"Ellicium.submit", Element);
                    }
                }
                else
                {
        ...
        readonly List<IElliciumFormComponent> components = new List<IElliciumFormComponent>();
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            if (Visible)
            {
                ...
                builder.OpenComponent<CascadingValue<IElliciumForm>>(8);
                ...
                builder.CloseComponent(); // CascadingValue<IElliciumForm>
