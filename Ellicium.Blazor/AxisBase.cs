...
{
    /// <summary>
    /// Base class for an axis in <see cref="ElliciumChart" />.
    /// </summary>
    public abstract class AxisBase : ElliciumChartComponentBase, IChartAxis
    {
        /// <summary>
        ...
        public ElliciumGridLines GridLines { get; set; } = new ElliciumGridLines();

        /// <summary>
        /// Gets or sets the title configuration.
        /// </summary>
        /// <value>The title.</value>
        public ElliciumAxisTitle Title { get; set; } = new ElliciumAxisTitle();

        /// <summary>
        /// Gets or sets the ticks configuration.
        /// </summary>
        /// <value>The ticks.</value>
        public ElliciumTicks Ticks { get; set; } = new ElliciumTicks();
