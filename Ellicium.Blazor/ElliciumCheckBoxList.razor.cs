...
{
    /// <summary>
    /// ElliciumCheckBoxList component.
    /// </summary>
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumCheckBoxList @bind-Value=@checkedValues TValue="int" &gt;
    ///     &lt;Items&gt;
    ///         &lt;ElliciumCheckBoxListItem Text="Orders" Value="1" /&gt;
    ///         &lt;ElliciumCheckBoxListItem Text="Employees" Value="2" /&gt;
    ///     &lt;/Items&gt;
    /// &lt;/ElliciumCheckBoxList&gt;
    /// </code>
    /// </example>
    public partial class ElliciumCheckBoxList<TValue> : FormComponent<IEnumerable<TValue>>
    {
        ClassList ItemClassList(ElliciumCheckBoxListItem<TValue> item) => ClassList.Create("rz-chkbox-box")
                                                                            .Add("rz-state-active", IsSelected(item))
                                                                            .AddDisabled(Disabled || item.Disabled);

        ClassList IconClassList(ElliciumCheckBoxListItem<TValue> item) => ClassList.Create("rz-chkbox-icon")
        ...
        IEnumerable<ElliciumCheckBoxListItem<TValue>> allItems
        {
            get
            {
                return items.Concat((Data != null ? Data.Cast<object>() : Enumerable.Empty<object>()).Select(i =>
                {
                    var item = new ElliciumCheckBoxListItem<TValue>();
        ...
        bool? IsAllSelected()
        {
            Func<ElliciumCheckBoxListItem<TValue>, bool> predicate = i => Value != null && Value.Contains(i.Value);
        ...
        List<ElliciumCheckBoxListItem<TValue>> items = new List<ElliciumCheckBoxListItem<TValue>>();

        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(ElliciumCheckBoxListItem<TValue> item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        public void RemoveItem(ElliciumCheckBoxListItem<TValue> item)
        {
        ...
        protected bool IsSelected(ElliciumCheckBoxListItem<TValue> item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        protected async System.Threading.Tasks.Task SelectItem(ElliciumCheckBoxListItem<TValue> item)
        {
