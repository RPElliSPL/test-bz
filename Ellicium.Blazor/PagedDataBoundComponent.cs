...
namespace Ellicium
{
    ...
    public class PagedDataBoundComponent<T> : ElliciumComponent
    {
        /// <summary>
        ...
        public async virtual Task Reload()
        {
            ...
            await LoadData.InvokeAsync(new Ellicium.LoadDataArgs() { Skip = skip, Top = PageSize });
        ...
        /// The top pager
        /// </summary>
        protected ElliciumPager topPager;
        /// <summary>
        /// The bottom pager
        /// </summary>
        protected ElliciumPager bottomPager;
