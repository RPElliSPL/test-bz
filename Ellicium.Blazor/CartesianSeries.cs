...
{
    /// <summary>
    /// Base class of <see cref="ElliciumChart" /> series.
    /// </summary>
    /// <typeparam name="TItem">The type of the series data.</typeparam>
    public abstract class CartesianSeries<TItem> : ElliciumChartComponentBase, IChartSeries, IDisposable
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public ElliciumMarkers Markers { get; set; } = new ElliciumMarkers();
