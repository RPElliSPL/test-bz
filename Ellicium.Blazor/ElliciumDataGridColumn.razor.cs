...
{
    /// <summary>
    /// ElliciumDataGridColumn component.
    /// Must be placed inside a <see cref="ElliciumDataGrid{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the DataGrid item.</typeparam>
    public partial class ElliciumDataGridColumn<TItem> : ComponentBase, IDisposable
    {
        /// <summary>
        ...
        [CascadingParameter]
        public ElliciumDataGridColumn<TItem> Parent { get; set; }
        ...
        bool visible = true;
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is visible.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is filterable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is sortable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is frozen.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the frozen position this <see cref="ElliciumDataGridColumn{TItem}"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is resizable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is reorderable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is groupable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumDataGridColumn{TItem}"/> is pickable - listed when DataGrid AllowColumnPicking is set to true.
        /// </summary>
        ...
        [Parameter]
        public RenderFragment<ElliciumDataGridColumn<TItem>> FilterTemplate { get; set; }
        ...
        [Parameter]
        public RenderFragment<ElliciumDataGridColumn<TItem>> FilterValueTemplate { get; set; }
        ...
        [Parameter]
        public RenderFragment<ElliciumDataGridColumn<TItem>> SecondFilterValueTemplate { get; set; }
        ...
        private static string GetStackedStyleForFrozen(IEnumerable<ElliciumDataGridColumn<TItem>> stackColumns, string position)
        {
            if (!stackColumns.Any())
            {
                return $"{position}:0";
        ...
        internal string GetSortOrderAsString(bool isOData)
        {
            ...
            return $"{p} {(GetSortOrder() == Ellicium.SortOrder.Ascending ? "asc" : "desc")}";
        }
        ...
        public async Task CloseFilter()
        {
            ...
            await Grid.GetJSRuntime().InvokeVoidAsync("Ellicium.closePopup", $"{Grid.PopupID}{GetFilterProperty()}");
        }
        ...
        internal ElliciumDataGridHeaderCell<TItem> headerCell;
    }
}
