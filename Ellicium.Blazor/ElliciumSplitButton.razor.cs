...
{
    /// <summary>
    /// ElliciumSplitButton component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumSplitButton Click=@(args => Console.WriteLine($"Value is: {args.Value}"))&gt;
    ///     &lt;ChildContent&gt;
    ///         &lt;ElliciumSplitButtonItem Text="Orders" Value="1" /&gt;
    ///         &lt;ElliciumSplitButtonItem Text="Employees" Value="2" /&gt;
    ///         &lt;ElliciumSplitButtonItem Text="Customers" Value="3" /&gt;
    ///     &lt;/ChildContent&gt;
    /// &lt;/ElliciumSelectBar&gt;
    /// </code>
    /// </example>
    public partial class ElliciumSplitButton : ElliciumComponentWithChildren
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ElliciumSplitButton"/> is disabled.
        /// </summary>
        ...
        [Parameter]
        public EventCallback<ElliciumSplitButtonItem> Click { get; set; }
        ...
        public async System.Threading.Tasks.Task OnClick(MouseEventArgs args)
        {
            if (!Disabled)
            {
                if (AlwaysOpenPopup)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.togglePopup", Element, PopupID);
                }
                else
                {
        ...
        private string OpenPopupScript()
        {
            ...
            return $"Ellicium.togglePopup(this.parentNode, '{PopupID}')";
        }
        ...
        internal bool IsFocused(ElliciumSplitButtonItem item)
        {
            return items?.IndexOf(item) == focusedIndex && focusedIndex != -1;
        }

        List<ElliciumSplitButtonItem> items = new List<ElliciumSplitButtonItem>();

        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(ElliciumSplitButtonItem item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        public void RemoveItem(ElliciumSplitButtonItem item)
        {
            if (items.IndexOf(item) != -1)
            {
                items.Remove(item);
