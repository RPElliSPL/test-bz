...
{
    /// <summary>
    /// ElliciumAccordion component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumAccordion&gt;
    ///     &lt;Items&gt;
    ///         &lt;ElliciumAccordionItem Text="Orders" Icon="account_balance_wallet"&gt;
    ///             Details for Orders
    ///         &lt;/ElliciumAccordionItem&gt;
    ///         &lt;ElliciumAccordionItem Text="Employees" Icon="account_box"&gt;
    ...
    public partial class ElliciumAccordion : ElliciumComponent
    {
        ...
        List<ElliciumAccordionItem> items = new List<ElliciumAccordionItem>();

        /// <summary>
        /// Adds the item.
        /// </summary>
        /// <param name="item">The item.</param>
        public void AddItem(ElliciumAccordionItem item)
        {
        ...
        /// </summary>
        /// <param name="item">The item.</param>
        public void RemoveItem(ElliciumAccordionItem item)
        {
        ...
        protected bool IsSelected(int index, ElliciumAccordionItem item)
        {
        ...
        protected string ItemTitle(int index, ElliciumAccordionItem item)
        {
        ...
        protected string ItemAriaLabel(int index, ElliciumAccordionItem item)
        {
            if (IsSelected(index, item))
            {
        ...
        internal async System.Threading.Tasks.Task SelectItem(ElliciumAccordionItem item, bool? value = null)
        {
        ...
        async System.Threading.Tasks.Task CollapseAll(ElliciumAccordionItem item)
        {
        ...
        internal bool IsFocused(ElliciumAccordionItem item)
        {
