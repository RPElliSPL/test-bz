...
{
    /// <summary>
    /// ElliciumDataList component.
    /// </summary>
    /// <typeparam name="TItem">The type of the item.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumDataList @data=@orders TItem="Order" AllowPaging="true" WrapItems="true"&gt;
    ///     &lt;Template&gt;
    ///         @context.OrderId
    ///     &lt;/Template&gt;
    /// &lt;/ElliciumDataList&gt;
    /// </code>
    /// </example>
    public partial class ElliciumDataList<TItem> : PagedDataBoundComponent<TItem>
    {
        /// <inheritdoc />
        ...
        {
            builder.OpenComponent<ElliciumDataListRow<TItem>>(0);
