...
{
    /// <summary>
    /// ElliciumRating component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumRating Stars="10" Change=@(args => Console.WriteLine($"Value: {args}")) /&gt;
    /// </code>
    /// </example>
    public partial class ElliciumSecurityCode : FormComponent<string>
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender || visibleChanged || disabledChanged || countChanged)
            {
                ...
                if (Visible && !Disabled)
                {
                    await JSRuntime.InvokeVoidAsync("Ellicium.createSecurityCode", GetId(), Reference, Element,
        ...
        public override void Dispose()
        {
            ...
            {
                JSRuntime.InvokeVoidAsync("Ellicium.destroySecurityCode", GetId(), Element);
            }
        }
        ...
        [JSInvokable("ElliciumSecurityCode.OnValueChange")]
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.focusSecurityCode", Element);
        }
#endif
    }
}
