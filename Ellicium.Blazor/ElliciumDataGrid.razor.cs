...
{
    /// <summary>
    /// ElliciumDataGrid component.
    /// </summary>
    /// <typeparam name="TItem">The type of the DataGrid data item.</typeparam>
    /// <example>
    /// <code>
    /// &lt;ElliciumDataGrid @data=@orders TItem="Order" AllowSorting="true" AllowPaging="true" AllowFiltering="true"&gt;
    ///     &lt;Columns&gt;
    ///         &lt;ElliciumDataGridColumn TItem="Order" Property="OrderId" Title="OrderId" /&gt;
    ///         &lt;ElliciumDataGridColumn TItem="Order" Property="OrderDate" Title="OrderDate" /&gt;
    ///     &lt;/Columns&gt;
    /// &lt;/ElliciumDataGrid&gt;
    /// </code>
    /// </example>
    public partial class ElliciumDataGrid<TItem> : PagedDataBoundComponent<TItem>
    {
        ...
        RenderFragment DrawRows(IList<ElliciumDataGridColumn<TItem>> visibleColumns)
        {
                ...
                if (AllowVirtualization)
                {
                    if(AllowGrouping && Groups.Any() && !LoadData.HasDelegate)
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<GroupResult>)((context) =>
                        {
                            ...
                            {
                                b.OpenComponent(3, typeof(ElliciumDataGridGroupRow<TItem>));
                    ...
                    else
                    {
                        ...
                        builder.AddAttribute(2, "ChildContent", (RenderFragment<TItem>)((context) =>
                        {
                            return (RenderFragment)((b) =>
                            {
                                b.OpenComponent<ElliciumDataGridRow<TItem>>(3);
                                b.AddAttribute(4, "Columns", visibleColumns);
                                b.AddAttribute(5, "Grid", this);
                                ...
                                {
                                    b.AddAttribute(10, nameof(ElliciumDataGridRow<TItem>.EditContext), editContexts[context]);
                                }
        ...
        internal void DrawGroupOrDataRows(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder builder, IList<ElliciumDataGridColumn<TItem>> visibleColumns)
        {
            if (Groups.Any())
            {
            ...
            else
            {
                ...
                {
                    builder.OpenComponent<ElliciumDataGridRow<TItem>>(0);
                    builder.AddAttribute(1, "Columns", visibleColumns);
                    ...
                    {
                        builder.AddAttribute(7, nameof(ElliciumDataGridRow<TItem>.EditContext), editContexts[item]);
                    }
        ...
        [Parameter]
        public EventCallback<Ellicium.DataGridLoadChildDataEventArgs<TItem>> LoadChildData { get; set; }
        ...
        internal string getFrozenColumnClass(ElliciumDataGridColumn<TItem> column, IList<ElliciumDataGridColumn<TItem>> visibleColumns)
        {
            if (!column.IsFrozen())
            {
                return "";
        ...
        internal string getColumnAlignClass(ElliciumDataGridColumn<TItem> column)
        {
        ...
        protected string DateFilterOperatorStyle(ElliciumDataGridColumn<TItem> column, FilterOperator value)
        {
        ...
        async Task FocusRow(string key)
        {
            try
            {
                var result = await JSRuntime.InvokeAsync<int[]>("Ellicium.focusTableRow", UniqueID, key, focusedIndex, focusedCellIndex, IsVirtualizationAllowed());
        ...
        /// <param name="column">The column.</param>
        protected virtual void OnFilterKeyPress(EventArgs args, ElliciumDataGridColumn<TItem> column)
        {
            Debounce(() => DebounceFilter(column), FilterDelay);
        }

        async Task DebounceFilter(ElliciumDataGridColumn<TItem> column)
        {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        protected void ApplyDateFilterByFilterOperator(ElliciumDataGridColumn<TItem> column, FilterOperator filterOperator)
        {
        ...
        private List<ElliciumDataGridColumn<TItem>> columns = new List<ElliciumDataGridColumn<TItem>>();
        internal readonly List<ElliciumDataGridColumn<TItem>> childColumns = new List<ElliciumDataGridColumn<TItem>>();
        internal List<ElliciumDataGridColumn<TItem>> allColumns = new List<ElliciumDataGridColumn<TItem>>();
        private List<ElliciumDataGridColumn<TItem>> allPickableColumns = new List<ElliciumDataGridColumn<TItem>>();
        ...
        internal void AddColumn(ElliciumDataGridColumn<TItem> column)
        {
        ...
        internal void UpdatePickableColumn(ElliciumDataGridColumn<TItem> column, bool visible)
        {
		...
		internal void RemoveColumn(ElliciumDataGridColumn<TItem> column)
        {
        ...
        void ToggleColumns()
        {
            var selected = ((IEnumerable<object>)selectedColumns).Cast<ElliciumDataGridColumn<TItem>>();
        ...
        string getFilterInputId(ElliciumDataGridColumn<TItem> column)
        {
            return string.Join("", $"{UniqueID}".Split('.')) + column.GetFilterProperty();
        }

        internal string getFilterDateFormat(ElliciumDataGridColumn<TItem> column)
        {
        ...
        internal RenderFragment DrawNumericFilter(ElliciumDataGridColumn<TItem> column, bool force = true, bool isFirst = true)
        {
            return new RenderFragment(builder =>
            {
        ...
        protected virtual async Task OnFilter(ChangeEventArgs args, ElliciumDataGridColumn<TItem> column, bool force = false, bool isFirst = true)
        {
        ...
        public IList<ElliciumDataGridColumn<TItem>> ColumnsCollection
        {
            get
            {
                return columns;
        ...
        internal async Task OnSort(EventArgs args, ElliciumDataGridColumn<TItem> column)
        {
        ...
        /// </summary>
        public async Task ClearFilter(ElliciumDataGridColumn<TItem> column, bool closePopup = false, bool shouldReload = true)
        {
            if (closePopup)
            {
            ...
            if (closePopup)
            {
                await JSRuntime.InvokeVoidAsync("Ellicium.closeAllPopups", $"{PopupID}{column.GetFilterProperty()}");
            }
        ...
        /// </summary>
        public async Task ApplyFilter(ElliciumDataGridColumn<TItem> column, bool closePopup = false)
        {
            if (closePopup)
            {
                if (column.headerCell != null)
        ...
        internal IReadOnlyDictionary<string, object> CellAttributes(TItem item, ElliciumDataGridColumn<TItem> column)
        {
            var args = new Ellicium.DataGridCellRenderEventArgs<TItem>() { Data = item, Column = column };
        ...
        internal IReadOnlyDictionary<string, object> HeaderCellAttributes(ElliciumDataGridColumn<TItem> column)
        {
            var args = new Ellicium.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        internal IReadOnlyDictionary<string, object> FooterCellAttributes(ElliciumDataGridColumn<TItem> column)
        {
            var args = new Ellicium.DataGridCellRenderEventArgs<TItem>() { Column = column };
        ...
        [Parameter]
        public RenderFragment<(Group Group, ElliciumDataGridGroupRow<TItem> GroupHeader)> GroupHeaderToggleTemplate { get; set; }
        ...
        {
            await JSRuntime.InvokeVoidAsync("Ellicium.stopColumnResize", getColumnUniqueId(columnIndex), Reference, columnIndex);
        }
        ...
        internal async Task StartColumnReorder(MouseEventArgs args, int columnIndex)
        {
            ...
            await JSRuntime.InvokeVoidAsync("Ellicium.startColumnReorder", getColumnUniqueId(columnIndex));
        }
        ...
        internal Dictionary<ElliciumDataGridGroupRow<TItem>, bool> collapsedGroupItems = new Dictionary<ElliciumDataGridGroupRow<TItem>, bool>();

        internal string ExpandedGroupItemStyle(ElliciumDataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal bool IsGroupItemExpanded(ElliciumDataGridGroupRow<TItem> item)
        {
        ...
        /// Expand group item.
        /// </summary>
        public async System.Threading.Tasks.Task ExpandGroupItem(ElliciumDataGridGroupRow<TItem> item, bool? expandedOnLoad)
        {
        ...
        internal Tuple<Ellicium.RowRenderEventArgs<TItem>, IReadOnlyDictionary<string, object>> RowAttributes(TItem item)
        {
            var args = new Ellicium.RowRenderEventArgs<TItem>() { Data = item, Expandable = Template != null || LoadChildData.HasDelegate };
        ...
        internal Tuple<GroupRowRenderEventArgs, IReadOnlyDictionary<string, object>> GroupRowAttributes(ElliciumDataGridGroupRow<TItem> item)
        {
            var args = new Ellicium.GroupRowRenderEventArgs() { Group = item.Group, FirstRender = firstRender };
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            {
                var args = new Ellicium.DataGridLoadSettingsEventArgs() { Settings = settings };
            ...
            if (Visible)
            {
                ...
                if (Render != null)
                {
                    Render(new Ellicium.DataGridRenderEventArgs<TItem>() { Grid = this, FirstRender = firstRender });
                }

                if (RenderAsync != null)
                {
                    await RenderAsync(new Ellicium.DataGridRenderEventArgs<TItem>() { Grid = this, FirstRender = firstRender });
                }
            }
        ...
        internal bool ShowGridLines(ElliciumDataGridColumn<TItem> column)
        {
        ...
        internal string getCompositeCellCSSClass(ElliciumDataGridColumn<TItem> column)
        {
        ...
        internal void SetColumnSortOrder(ElliciumDataGridColumn<TItem> column)
        {
        ...
        void GroupsCollectionChanged(object sender, NotifyCollectionChangedEventArgs args)
        {
            ...
            {
                ElliciumDataGridColumn<TItem> column;
        ...
        List<ElliciumDataGridColumn<TItem>> groupedColumns = new List<ElliciumDataGridColumn<TItem>>();
        /// <summary>
        ...
        internal async Task EndColumnDropToGroup()
        {
            ...
            {
                var functionName = $"Ellicium['{getColumnUniqueId(indexOfColumnToReoder.Value)}end']";
