...
{
    /// <summary>
    /// ElliciumSteps component.
    /// </summary>
    /// <example>
    /// <code>
    /// &lt;ElliciumSteps Change=@(args => Console.WriteLine($"Selected index is: {args}"))&gt;
    ///     &lt;Steps&gt;
    ///         &lt;ElliciumStepsItem Text="Orders"&gt;
    ///             Details for Orders
    ///         &lt;/ElliciumStepsItem&gt;
    ///         &lt;ElliciumStepsItem Text="Employees"&gt;
    ...
    public partial class ElliciumSteps : ElliciumComponent
    {
        ...
        public IList<ElliciumStepsItem> StepsCollection { get => steps; }
        ...
        /// <example>
        /// <code>
        /// &lt;ElliciumSteps CanChange=@OnCanChange&gt;
        /// &lt;/ElliciumSteps&gt;
        /// @code {
        ///  void OnCanChange(ElliciumStepsCanChangeEventArgs args)
        ///  {
        ///     args.PreventDefault();
        ///  }
        /// }
        ...
        List<ElliciumStepsItem> steps = new List<ElliciumStepsItem>();

        /// <summary>
        /// Adds the step.
        /// </summary>
        /// <param name="step">The step.</param>
        public void AddStep(ElliciumStepsItem step)
        {
        ...
        public void RemoveStep(ElliciumStepsItem item)
        {
        ...
        protected bool IsSelected(int index, ElliciumStepsItem step)
        {
            return SelectedIndex == index;
        }

        internal async System.Threading.Tasks.Task SelectStep(ElliciumStepsItem step, bool raiseChange = false)
        {
