...
namespace Ellicium.Blazor
{
    ...
    public partial class ElliciumSSRSViewer : ElliciumComponent
    {
        ...
        List<ElliciumSSRSViewerParameter> parameters = new List<ElliciumSSRSViewerParameter>();

        /// <summary>
        /// Adds the parameter.
        /// </summary>
        /// <param name="parameter">The parameter.</param>
        public void AddParameter(ElliciumSSRSViewerParameter parameter)
        {
