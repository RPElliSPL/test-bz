...
{
    /// <summary>
    /// ElliciumDataFilterProperty component.
    /// Must be placed inside a <see cref="ElliciumDataFilter{TItem}" />
    /// </summary>
    /// <typeparam name="TItem">The type of the DataFilter item.</typeparam>
    public partial class ElliciumDataFilterProperty<TItem> : ComponentBase, IDisposable
    {
        ...
        internal void RemoveColumn(ElliciumDataFilterProperty<TItem> property)
        {
