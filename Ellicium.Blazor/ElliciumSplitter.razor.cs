...
namespace Ellicium.Blazor
{
    ...
    public partial class ElliciumSplitter : ElliciumComponent
    {
        ...
        internal List<ElliciumSplitterPane> Panes = new List<ElliciumSplitterPane>();

        /// <summary>
        /// Adds the pane.
        /// </summary>
        /// <param name="pane">The pane.</param>
        public void AddPane(ElliciumSplitterPane pane)
        {
        ...
        /// </summary>
        /// <param name="pane">The pane.</param>
        public void RemovePane(ElliciumSplitterPane pane)
        {
        ...
        internal Task StartResize(MouseEventArgs args, int paneIndex)
        {
            ...
            return JSRuntime.InvokeVoidAsync("Ellicium.startSplitterResize",
                UniqueID,
                Reference,
                pane.UniqueID,
        ...
        /// </summary>
        [JSInvokable("ElliciumSplitter.OnPaneResizing")]
        ...
        [JSInvokable("ElliciumSplitter.OnPaneResized")]
        public async Task OnPaneResized(int paneIndex, double sizeNew, int? paneNextIndex, double? sizeNextNew)
        {
            ...
            {
                var arg = new ElliciumSplitterResizeEventArgs { PaneIndex = pane.Index, Pane = pane, NewSize = sizeNew };
            ...
            if (paneNextIndex.HasValue)
            {
                ...
                {
                    var arg = new ElliciumSplitterResizeEventArgs { PaneIndex = paneNext.Index, Pane = paneNext, NewSize = sizeNextNew.Value };
                    await Resize.InvokeAsync(arg);
        ...
        internal async Task OnCollapse(int paneIndex)
        {
            ...
            if (paneNext != null && paneNext.Collapsible && paneNext.IsLast && paneNext.GetCollapsed())
            {
                if (Expand.HasDelegate)
                {
                    var arg = new ElliciumSplitterEventArgs { PaneIndex = paneNext.Index, Pane = paneNext };
            ...
            else
            {
                ...
                {
                    var arg = new ElliciumSplitterEventArgs { PaneIndex = pane.Index, Pane = pane };
        ...
        [Parameter]
        public EventCallback<ElliciumSplitterEventArgs> Collapse { get; set; }
        ...
        [Parameter]
        public EventCallback<ElliciumSplitterEventArgs> Expand { get; set; }
        ...
        [Parameter]
        public EventCallback<ElliciumSplitterResizeEventArgs> Resize { get; set; }
    }
}
