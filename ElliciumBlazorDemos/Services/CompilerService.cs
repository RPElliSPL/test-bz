...
using ElliciumBlazorDemos.Shared;
...
@using ElliciumBlazorDemos.Shared
@using ElliciumBlazorDemos.Pages
";
        ...
        private async Task InitializeAsync()
        {
            ...
            compilation = CSharpCompilation.Create(
                 "ElliciumBlazorDemos.DynamicAssembly",
            ...
            {
                builder.SetRootNamespace("ElliciumBlazorDemos");
        ...
        private async Task<IEnumerable<Stream>> GetStreamsAsync()
        {
             var referenceAssemblyRoots = new[]
             {
                 ...
                 typeof(ElliciumButton).Assembly,
        ...
        public async Task<Type> CompileAsync(string source)
        {
            ...
            var type = assembly.GetType("ElliciumBlazorDemos.DynamicComponent");
