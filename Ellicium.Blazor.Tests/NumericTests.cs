...
namespace Ellicium.Blazor.Tests
{
    public class NumericTests
    {
        ...
        public void Numeric_Renders_CssClasses()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<double>>();
        ...
        public void Numeric_UpDown_NotRenderedIfHidden()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<double>>(ComponentParameter.CreateParameter(nameof(ElliciumNumeric<double>.ShowUpDown), false));
        ...
        public void Numeric_Formatted()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<double>>(
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<double>.Format), format),
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<double>.Value), valueToTest)
            );
        ...
        public void Numeric_Formatter_PreservesLeadingZeros(decimal oldValue, decimal newValue)
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<decimal>>(
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<decimal>.Format), format),
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<decimal>.Value), oldValue)
            );
        ...
        public void Numeric_Uses_ConvertValue()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<Dollars?>>(
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Dollars?>.ConvertValue), (Func<string, Dollars?>)ConvertFunc),
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Dollars?>.Value), value)
            );
        ...
        public void Numeric_Supports_TypeConverter()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<Dollars>>(
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Dollars>.Format), format),
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Dollars>.Value), valueToTest)
            );
        ...
        public void Numeric_Supports_IFormattable()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumeric<Temperature>>(
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Temperature>.Format), format),
                ComponentParameter.CreateParameter(nameof(ElliciumNumeric<Temperature>.Value), valueToTest)
            );
