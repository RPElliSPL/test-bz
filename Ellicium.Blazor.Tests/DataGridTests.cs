...
namespace Ellicium.Blazor.Tests
{
    public class DataGridTests
    {
        ...
        public void DataGrid_Renders_CssClass()
        {
            ...
            var component = ctx.RenderComponent<ElliciumGrid<dynamic>>(parameterBuilder =>
            {
                parameterBuilder.Add<IEnumerable<dynamic>>(p => p.Data, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } });
                parameterBuilder.Add<RenderFragment>(p => p.Columns, builder =>
                {
                    builder.OpenComponent(0, typeof(ElliciumGridColumn<dynamic>));
        ...
        public void DataGrid_Renders_TitleAttribute()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDataGrid<dynamic>>(parameterBuilder =>
            {
                parameterBuilder.Add(p => p.ShowColumnTitleAsTooltip, true);
                parameterBuilder.Add<IEnumerable<dynamic>>(p => p.Data, new[] { new { Id = 1 }, new { Id = 2 }, new { Id = 3 } });
                parameterBuilder.Add<RenderFragment>(p => p.Columns, builder =>
                {
                    builder.OpenComponent(0, typeof(ElliciumDataGridColumn<dynamic>));
                    builder.AddAttribute(1, "Title", "MyId");
                    builder.CloseComponent();
                });
            });
        ...
        public void DataGrid_Renders_ColumnHeaderTemplate()
        {
            ...
            var component = ctx.RenderComponent<ElliciumGrid<int>>(parameterBuilder =>
            {
                parameterBuilder.Add<IEnumerable<int>>(p => p.Data, new[] { 1, 2, 3 });
                parameterBuilder.Add<RenderFragment>(p => p.Columns, builder =>
                {
                    builder.OpenComponent(0, typeof(ElliciumGridColumn<int>));
        ...
        public void DataGrid_Renders_AllowPagingParameter()
        {
            ...
            var component = ctx.RenderComponent<ElliciumGrid<int>>(parameterBuilder => parameterBuilder.Add<IEnumerable<int>>(p => p.Data, Enumerable.Range(0, 100)));
        ...
        public void DataGrid_Renders_DefaultEmptyText()
        {
            ...
            var component = ctx.RenderComponent<ElliciumGrid<int>>(parameterBuilder => parameterBuilder.Add<IEnumerable<int>>(p => p.Data, Array.Empty<int>()));
            component.Render();
