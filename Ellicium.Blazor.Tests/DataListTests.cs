...
namespace Ellicium.Blazor.Tests
{
    public class DataListTests
    {
        ...
        public void DataList_Renders_CssClass()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDataList<int>>(parameterBuilder => parameterBuilder.Add<IEnumerable<int>>(p => p.Data, new[] { 1,2,3}));
        ...
        public void DataList_Renders_AllowPagingParameter()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDataList<int>>(parameterBuilder => parameterBuilder.Add<IEnumerable<int>>(p => p.Data, Enumerable.Range(0, 100)));
