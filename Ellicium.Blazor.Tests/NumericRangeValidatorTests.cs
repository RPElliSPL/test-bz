...
namespace Ellicium.Blazor.Tests
{
    ...
    {
        class FormComponentTestDouble : IElliciumFormComponent
        {
        ...
        class ElliciumNumericRangeValidatorTestDouble : ElliciumNumericRangeValidator
        {
        ...
        {
            var validator = new ElliciumNumericRangeValidatorTestDouble();
        ...
        public void Returns_False_If_Value_Is_Null()
        {
            ...
            var component = ctx.RenderComponent<ElliciumNumericRangeValidatorTestDouble>();
