...
namespace Ellicium.Blazor.Tests
{
    public class SpeechToTextButtonTests
    {
        ...
        public void SpeechToTextButton_Renders_Record_Button_When_Visible()
        {
            ...
            var component = ctx.RenderComponent<ElliciumSpeechToTextButton>();
        ...
        public void SpeechToTextButton_Renders_Additional_Css()
        {
            ...
            var component =
                ctx.RenderComponent<ElliciumSpeechToTextButton>(ComponentParameter.CreateParameter("class", "another-class"));
        ...
        public void SpeechToTextButton_Can_Override_Default_Title_And_Aria_Label()
        {
            ...
            var component =
                ctx.RenderComponent<ElliciumSpeechToTextButton>(
