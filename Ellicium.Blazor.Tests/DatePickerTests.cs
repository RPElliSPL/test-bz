...
namespace Ellicium.Blazor.Tests
{
    public class DatePickerTests
    {
        ...
        public void DatePicker_Renders_CssClass()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<DateTime>>();
        ...
        public void DatePicker_Raises_ValueChangedEvent_Returns_PreviousDateOnInputOnDisabledDates()
        {
            ...
            ctx.JSInterop.Setup<string>("Ellicium.getInputValue", invocation => true).SetResult(previousDay.ToShortDateString());
            inputElement.Change(previousDay.AddDays(-1));

            // try to enter disabled date
            ctx.JSInterop.Setup<string>("Ellicium.getInputValue", invocation => true).SetResult(DateTime.Today.ToShortDateString());
        ...
        public void DatePicker_Parses_Input_Using_DateFormat()
        {
            ...
            string input = "3012";
            ctx.JSInterop.Setup<string>("Ellicium.getInputValue", invocation => true).SetResult(input);
        ...
        public void DatePicker_Respects_DateTimeMaxValue()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<DateTime>>(parameters =>
            {
        ...
        public void DatePicker_Converts_DateTimeOffSet_FromUtc_ToLocal()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<DateTimeOffset>>(parameters =>
            {
        ...
        public void DatePicker_Supports_DateOnly()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<DateOnly?>>(parameters =>
            {
            ...
            ctx.JSInterop.Setup<string>("Ellicium.getInputValue", invocation => true).SetResult(enteredValue.Value.ToShortDateString());
        ...
        public void DatePicker_Supports_TimeOnly()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<TimeOnly>>(parameters =>
            {
            ...
            ctx.JSInterop.Setup<string>("Ellicium.getInputValue", invocation => true).SetResult(enteredValue.Value.ToLongTimeString());
            inputElement.Change(enteredValue);
        ...
        public void DatePicker_ShowCalendarWeek_WeekNumberAddedInAdditionalColumn()
        {
            ...
            var component = ctx.RenderComponent<ElliciumDatePicker<DateTime>>(parameter =>
            {
