...
namespace Ellicium.Blazor.Tests
{
    public class DropDownTests
    {
        ...
        private static IRenderedComponent<ElliciumDropDown<T>> DropDown<T>(TestContext ctx, Action<ComponentParameterCollectionBuilder<ElliciumDropDown<T>>> configure = null)
        {
            var data = new [] {
            ...
            var component = ctx.RenderComponent<ElliciumDropDown<T>>();
